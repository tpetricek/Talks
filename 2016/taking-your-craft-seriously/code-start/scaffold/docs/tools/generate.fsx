...
let website = "/PasswordValidator"

let githubLink = "http://github.com/tpetricek/PasswordValidation"

// Specify more information about your project
let info =
  [ "project-name", "PasswordValidator"
    "project-author", "Tomas Petricek"
    "project-summary", "A demo project that implements a simple password validation library"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/PasswordValidator" ]
