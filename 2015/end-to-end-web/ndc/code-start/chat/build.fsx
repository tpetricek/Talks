...
// The loaded WebPart is then hosted at localhost:8035.
// --------------------------------------------------------------------------------------
...
let serverConfig =
  { defaultConfig with
      ...
      bindings = [ HttpBinding.mk' HTTP  "127.0.0.1" 8035] }
...
Target "run" (fun _ ->
  ...
  System.Diagnostics.Process.Start("http://localhost:8035") |> ignore
