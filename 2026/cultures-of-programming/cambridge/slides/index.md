...
- style: .body img { max-width:90%; margin-left:0px; } h2 { color: #2C68AC; } p { font-size:24pt; }

# Halfway through my PhD...
## What am I doing here?

**Type providers for F#**

with Don Syme at Microsoft
...
**Are different ways of thinking incommensurable?**
...
----------------------------------------------------------------------------------------------------
- template: icons
- style: li { letter-spacing:-1px; } i { margin-right:10px; }

# Aesthetics
## Cultures clash over values

- *fa-code* What makes for good source code?
- *fa-user-graduate* Empowering users or pragmatic problem solving
- *fa-circle-check* What are the right quality standards?
- *fa-robot* Does source code even matter?
...
What assumptions do we rarely question?  
Talk to your local philosopher of science!  
